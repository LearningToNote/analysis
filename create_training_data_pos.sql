...
DROP TYPE T_TD_POS;
CREATE TYPE T_TD_POS AS TABLE (DDI TINYINT, "BEFORE" TEXT, BETWEEN TEXT, AFTER TEXT, P_BEFORE TEXT, P_BETWEEN TEXT, P_AFTER TEXT);

DROP TYPE T_R_STAT;
CREATE TYPE T_R_STAT AS TABLE (NAME VARCHAR(255), VALUE DOUBLE);

DROP TABLE LEARNING_TO_NOTE.TD_POS_NOSTOP;
CREATE COLUMN TABLE LEARNING_TO_NOTE.TD_POS_NOSTOP LIKE LEARNING_TO_NOTE.T_TD_POS;

INSERT INTO LEARNING_TO_NOTE.TD_POS_NOSTOP
SELECT DDI,
...
SELECT * FROM LEARNING_TO_NOTE.TD_POS_NOSTOP;