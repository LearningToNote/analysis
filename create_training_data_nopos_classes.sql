DROP TYPE T_TD_NOPOS_CLASSES;
CREATE TYPE T_TD_NOPOS_CLASSES AS TABLE (DDI VARCHAR(255), "BEFORE" TEXT, BETWEEN TEXT, AFTER TEXT);

DROP TABLE LEARNING_TO_NOTE.TD_NOPOS_CLASSES;
CREATE COLUMN TABLE LEARNING_TO_NOTE.TD_NOPOS_CLASSES LIKE LEARNING_TO_NOTE.T_TD_NOPOS_CLASSES;


INSERT INTO LEARNING_TO_NOTE.TD_NOPOS_CLASSES
SELECT DDI,
