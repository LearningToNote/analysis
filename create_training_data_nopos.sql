DROP TABLE LEARNING_TO_NOTE.TD_NOPOS;
CREATE COLUMN TABLE LEARNING_TO_NOTE.TD_NOPOS LIKE LEARNING_TO_NOTE.T_TD_NOPOS;

DROP TYPE T_TD_NOPOS;
CREATE TYPE T_TD_NOPOS AS TABLE (DDI TINYINT, "BEFORE" TEXT, BETWEEN TEXT, AFTER TEXT);

INSERT INTO LEARNING_TO_NOTE.TD_NOPOS
SELECT DDI,
