...
CREATE COLUMN TABLE TRAIN_RESULT LIKE T_TD_NOPOS_CLASSES;
...
BEGIN
    train_data = SELECT * FROM TD_NOPOS_CLASSES;
    CALL R_PREDICT(:train_data, T_TD_NOPOS_CLASSES, T_R_STAT);
    INSERT INTO TRAIN_RESULT SELECT * FROM :T_TD_NOPOS_CLASSES;
