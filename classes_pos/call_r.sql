...
CREATE COLUMN TABLE TRAIN_RESULT LIKE T_TD_POS_CLASSES;
...
BEGIN
    train_data = SELECT * FROM T_TD_POS_CLASSES;
    CALL R_PREDICT(:train_data, T_TD_POS_CLASSES, T_R_STAT);
    INSERT INTO TRAIN_RESULT SELECT * FROM :T_TD_POS_CLASSES;
