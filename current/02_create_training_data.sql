	...
	FROM (
		...
		FROM(
			...
			FROM (
				...
				JOIN LTN_DEVELOP.ENTITIES E1 ON P.E1_ID = E1.ID
				JOIN LTN_DEVELOP.ENTITIES E2 ON P.E2_ID = E2.ID
				JOIN LTN_DEVELOP.USER_DOCUMENTS UD ON E1.USER_DOC_ID = UD.ID AND E2.USER_DOC_ID = UD.ID AND P.USER_DOC_ID = UD.ID
