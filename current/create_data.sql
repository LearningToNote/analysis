...
SELECT DDI, E1_ID, E2_ID, E1_TYPE, E2_TYPE, DIST,
...
FROM (
	SELECT E1_ID, E2_ID, DDI, E1_TYPE, E2_TYPE, DIST,
	...
	GROUP BY E1_ID, E2_ID, DDI, E1_TYPE, E2_TYPE, DIST, POSITION
	ORDER BY E1_ID, E2_ID, POSITION
)
GROUP BY E1_ID, E2_ID, DDI, E1_TYPE, E2_TYPE, DIST;
