...
CREATE PROCEDURE CALL_R_TRAIN_BINARY(IN train_data T_TRAIN_DATA)
...
CREATE PROCEDURE CALL_R_TRAIN_CLASSES(IN train_data T_TRAIN_DATA)
LANGUAGE SQLSCRIPT AS
BEGIN
...
--     CALL CALL_R_TRAIN_BINARY(:train_data);
--     CALL CALL_R_TRAIN_CLASSES(:train_data);
